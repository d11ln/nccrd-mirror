namespace NCCRD.Database.Migrations
{
    ...
    public partial class UpdatePolygonFilter : DbMigration
    {
        public override void Up()
        {
            StringBuilder storedProcedureCode = new StringBuilder();

            storedProcedureCode.Append("ALTER PROCEDURE dbo.PolygonFilter" + Environment.NewLine);
            ...
            storedProcedureCode.Append("'SELECT Project.ProjectId, Project.ProjectTitle, Project.ProjectDescription, Location.LocationId, Location.LatCalculated, Location.LonCalculated" + Environment.NewLine);
